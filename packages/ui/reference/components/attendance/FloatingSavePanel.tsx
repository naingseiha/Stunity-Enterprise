...
export function FloatingSavePanel({
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 animate-slideUp">
      <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-2xl shadow-2xl p-6 min-w-[420px]">
        <div className="flex items-start justify-between mb-4">
          <div className="text-white">
            <p className="text-lg font-black flex items-center gap-2">
              📋 វត្តមានរង់ចាំរក្សាទុក
            ...
            <div className="mt-3 space-y-1.5 text-sm">
              ...
              {editedCount > 0 && (
                <p className="flex items-center gap-2">
                  ...
                  បានកែសម្រួលបន្ថែម: <span className="font-bold">{editedCount}</span>{" "}
                  cells
                </p>
              )}
        ...
        <div className="flex gap-3 mt-4">
          ...
          <button
            onClick={onSave}
            disabled={saving}
            className="flex-1 px-6 py-3.5 bg-white hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed rounded-xl text-indigo-600 font-bold shadow-lg transition-all flex items-center justify-center gap-2"
          >
            {saving ? (
              <>
