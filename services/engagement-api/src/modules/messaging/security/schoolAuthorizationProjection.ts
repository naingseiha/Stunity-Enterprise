// Mirrors services/auth-service/src/security/schoolAuthorizationProjection.ts.
// Kept as a local copy (no shared package boundary exists between services yet)
// so messaging-service can run the same Phase 5 shadow-read comparison without
// depending on auth-service's internals.
