/**
 * Seed script for Analytics Service
...
const achievements = [
  {
    ...
    key: 'first_perfect',
    name: 'Perfect Score',
    description: 'Get your first perfect score on a quiz',
    icon: '🎯',
  ...
  },
  {
    ...
    key: 'speed_demon',
    name: 'Speed Demon',
    description: 'Complete a quiz in under 50% of the time limit',
    icon: '⚡',
    category: 'performance',
    tier: 'silver',
    xpReward: 75,
  ...
  },
  {
    ...
    key: 'first_win',
    name: 'First Win',
    description: 'Win your first live quiz session',
    icon: '🥇',
