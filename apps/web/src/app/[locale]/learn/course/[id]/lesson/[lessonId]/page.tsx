...
function AssignmentWidget({
  ...
  return (
    <div className="min-h-full w-full overflow-y-auto bg-[radial-gradient(circle_at_top_left,_rgba(14,165,233,0.18),_transparent_35%),radial-gradient(circle_at_bottom_right,_rgba(16,185,129,0.18),_transparent_35%)] p-4 sm:p-8 dark:bg-[radial-gradient(circle_at_top_left,_rgba(14,165,233,0.18),_transparent_25%),radial-gradient(circle_at_bottom_right,_rgba(45,212,191,0.14),_transparent_30%)]">
      <div className="lesson-surface mx-auto grid w-full max-w-5xl gap-6 rounded-[30px] border border-slate-200 dark:border-gray-800/80 bg-white dark:bg-gray-900/90 p-4 shadow-[0_30px_90px_-40px_rgba(15,23,42,0.45)] backdrop-blur sm:p-6 lg:grid-cols-[320px_minmax(0,1fr)] dark:border-white/10 dark:bg-slate-900/80">
        <div className="flex flex-col rounded-[26px] bg-gradient-to-br from-slate-950 via-sky-950 to-cyan-900 p-6 text-white shadow-inner">
          <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-white dark:bg-gray-900/10">
        ...
        <div className="flex min-h-[420px] flex-col rounded-[26px] border border-slate-200 dark:border-gray-800/80 bg-slate-50 dark:bg-gray-800/50 p-5 dark:border-white/10 dark:bg-gray-900/[0.03]">
          ...
          {!isSubmitted ? (
            <div className="mt-auto space-y-5">
              <div className="inline-flex w-full gap-2 rounded-2xl bg-slate-200/70 p-1.5 dark:bg-gray-900/5">
                <button
                  onClick={() => setSubmissionType('url')}
                  className={`flex-1 rounded-xl px-4 py-3 text-sm font-semibold transition-all ${
                    submissionType === 'url'
                      ? 'bg-white dark:bg-gray-900 text-slate-900 dark:text-white shadow-sm dark:bg-slate-800 dark:text-white'
...
export default function LessonViewerPage() {
  ...
  if (!lesson) {
    return (
      <div className="min-h-screen bg-[#eef2f7] px-4 text-slate-900 dark:text-white dark:bg-[#020617] dark:text-white">
        <div className="mx-auto flex min-h-screen max-w-2xl items-center justify-center">
          <div className="w-full rounded-[32px] border border-slate-200 dark:border-gray-800/80 bg-white dark:bg-gray-900/90 p-10 text-center shadow-[0_30px_90px_-40px_rgba(15,23,42,0.45)] backdrop-blur dark:border-white/10 dark:bg-slate-900/80">
      ...
      case 'AUDIO':
        return lesson.videoUrl ? (
                          ...
                          <button
                            ...
                            className={`rounded-full border px-3 py-1 text-xs font-semibold transition-colors ${
                              isActive
                                ...
                                : 'border-white/20 bg-white dark:bg-gray-900/5 text-slate-300 hover:border-sky-500/40 hover:text-sky-100'
                            }`}
                          >
          ...
          <div className="flex h-full min-h-[420px] items-center justify-center bg-[radial-gradient(circle_at_top,_rgba(14,165,233,0.14),_transparent_35%),linear-gradient(180deg,#020617_0%,#0f172a_100%)] p-6">
            <div className="w-full max-w-3xl rounded-[28px] border border-white/10 bg-white dark:bg-none dark:bg-gray-900/5 p-8 text-center shadow-2xl backdrop-blur">
      ...
      case 'QUIZ':
        ...
        return (
          <div className="flex h-full min-h-[420px] items-center justify-center bg-[radial-gradient(circle_at_top,_rgba(59,130,246,0.18),_transparent_35%),linear-gradient(180deg,#eff6ff_0%,#dbeafe_100%)] p-6 dark:bg-[radial-gradient(circle_at_top,_rgba(56,189,248,0.18),_transparent_30%),linear-gradient(180deg,#020617_0%,#0f172a_100%)]">
            <div className="w-full max-w-2xl rounded-[28px] border border-slate-200 dark:border-gray-800/80 bg-white dark:bg-gray-900/95 p-8 text-center shadow-xl dark:border-white/10 dark:bg-slate-900/80">
              <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-3xl bg-sky-100 text-sky-600 dark:bg-sky-500/10 dark:text-sky-300">
      ...
      case 'IMAGE':
        return (
          <div className="flex min-h-[520px] h-full items-center justify-center bg-[radial-gradient(circle_at_top,_rgba(14,165,233,0.14),_transparent_30%),linear-gradient(180deg,#f8fafc_0%,#e2e8f0_100%)] p-6 dark:bg-[radial-gradient(circle_at_top,_rgba(14,165,233,0.16),_transparent_28%),linear-gradient(180deg,#020617_0%,#0f172a_100%)]">
            <div className="w-full max-w-6xl rounded-[30px] border border-slate-200 dark:border-gray-800/80 bg-white dark:bg-gray-900/90 p-4 shadow-2xl dark:border-white/10 dark:bg-slate-900/80">
              {lesson.content ? (
            ...
            <div className="mx-auto w-full max-w-7xl">
              <div className="grid gap-6 xl:grid-cols-[minmax(0,1.2fr)_360px]">
                <div className="min-w-0 rounded-[32px] border border-slate-200 dark:border-gray-800/80 bg-white dark:bg-gray-900/95 p-4 shadow-2xl dark:border-white/10 dark:bg-slate-900/80">
                  <div className="flex flex-wrap items-center justify-between gap-3 rounded-[24px] border border-slate-200 dark:border-gray-800/70 bg-slate-50 dark:bg-gray-800/50 px-4 py-3 dark:border-white/10 dark:bg-gray-900/[0.03]">
                    ...
                    {primaryLessonResource && (
                      <div className="flex flex-wrap items-center gap-2">
                        <span className="rounded-full border border-slate-200 dark:border-gray-800 bg-white dark:bg-gray-900 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.12em] text-slate-600 dark:border-white/10 dark:bg-slate-950/50 dark:text-slate-300">
                        ...
                        {formatResourceSize(primaryLessonResource.size) && (
                          <span className="rounded-full border border-slate-200 dark:border-gray-800 bg-white dark:bg-gray-900 px-3 py-1 text-[11px] font-medium text-slate-500 dark:border-white/10 dark:bg-slate-950/50 dark:text-slate-400">
                            {formatResourceSize(primaryLessonResource.size)}
                          </span>
                        )}
                      </div>
                  ...
                  <div className="mt-4 overflow-hidden rounded-[28px] border border-slate-200 dark:border-gray-800/70 bg-slate-950 dark:border-white/10">
                    {primaryLessonResourceUrl && primaryLessonPreviewMode === 'pdf' ? (
                      <iframe
                        ...
                        className="h-[72vh] min-h-[480px] w-full bg-white dark:bg-gray-900"
                      />
                      ...
                      <div className="flex min-h-[480px] items-center justify-center bg-[radial-gradient(circle_at_top,_rgba(56,189,248,0.16),_transparent_35%),linear-gradient(180deg,#0f172a_0%,#020617_100%)] p-8">
                        <div className="w-full max-w-2xl rounded-[28px] border border-white/10 bg-white dark:bg-none dark:bg-gray-900/5 p-8 text-center backdrop-blur">
                      ...
                      <div className="mt-4 space-y-3">
                        {visibleResources.map((resource) => (
                          <a
                            ...
                            className="group flex items-center justify-between rounded-2xl border border-slate-200 dark:border-gray-800 bg-slate-50 dark:bg-none dark:bg-gray-800/50 px-4 py-3 text-sm transition-all hover:-translate-y-0.5 hover:border-sky-200 hover:bg-white dark:bg-none dark:bg-gray-900 dark:border-white/10 dark:bg-none dark:bg-gray-900/[0.03] dark:hover:border-sky-500/20 dark:hover:bg-white dark:bg-none dark:bg-gray-900/[0.05]"
                          >
                      ...
                      <div className="mt-4 grid gap-3 sm:grid-cols-2">
                        {visibleResources.map((resource) => (
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="group flex items-center justify-between rounded-2xl border border-slate-200 dark:border-gray-800 bg-slate-50 dark:bg-gray-800/50 px-4 py-4 transition-all hover:-translate-y-0.5 hover:border-sky-200 hover:bg-white dark:bg-gray-900 dark:border-white/10 dark:bg-gray-900/[0.03] dark:hover:border-sky-500/20 dark:hover:bg-white dark:bg-gray-900/[0.05]"
                          >
                            <div className="flex items-center gap-3">
                              <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-slate-900 text-white dark:bg-gray-900 dark:text-white">
                                <Download className="h-4 w-4" />
                              </div>
                              <div>
  ...
  const sidebarContent = (
    <div className="lesson-surface lesson-sidebar flex h-full flex-col overflow-hidden rounded-[30px] border border-slate-200 dark:border-gray-800/80 bg-white dark:bg-gray-900/80 shadow-[0_30px_90px_-40px_rgba(15,23,42,0.35)] backdrop-blur dark:border-white/10 dark:bg-slate-900/75">
      ...
      <div className="border-b border-slate-200 dark:border-gray-800/70 px-5 py-5 dark:border-white/10">
        ...
        <div className="mt-4 h-2 overflow-hidden rounded-full bg-slate-200 dark:bg-none dark:bg-gray-900/10">
        ...
        <div className="mt-4">
          <button
            ...
            className="lesson-panel inline-flex w-full items-center justify-between gap-3 rounded-2xl border border-slate-200 dark:border-gray-800 bg-white dark:bg-none dark:bg-gray-900 px-4 py-3 text-sm font-semibold text-slate-700 dark:text-gray-200 transition hover:border-slate-300 dark:border-gray-700 hover:text-slate-900 dark:text-white dark:border-white/10 dark:bg-slate-950/50 dark:text-slate-200 dark:hover:border-white/20 dark:hover:text-white"
          >
              ...
              <button
                ...
                className={`lesson-panel inline-flex items-center justify-center gap-2 rounded-2xl border px-4 py-3 text-sm font-semibold transition ${
                  showBookmarkedOnly
                    ...
                    : 'border-slate-200 dark:border-gray-800 bg-white dark:bg-gray-900 text-slate-600 dark:border-white/10 dark:bg-slate-950/50 dark:text-slate-300'
                }`}
              >
      ...
      <div className="flex-1 overflow-y-auto p-3 scrollbar-on-hover">
        <div className="space-y-3">
          {filteredSections.map((section) => {
            ...
            return (
              <div key={section.id} className="lesson-panel rounded-[26px] border border-slate-200 dark:border-gray-800/80 bg-slate-50 dark:bg-gray-800/50 p-2 dark:border-white/10 dark:bg-gray-900/[0.03]">
                <button
                  onClick={() => setExpandedSections((prev) => ({ ...prev, [section.id]: !isExpanded }))}
                  className="flex w-full items-center justify-between gap-3 rounded-[20px] px-3 py-3 text-left transition-colors hover:bg-white dark:bg-gray-900/80 dark:hover:bg-white dark:bg-gray-900/[0.04]"
                >
                  <div className="min-w-0">
                  ...
                  <div className="flex items-center gap-3">
                    <span className="rounded-full bg-white dark:bg-gray-900 px-2.5 py-1 text-[11px] font-semibold text-slate-600 dark:bg-slate-950/50 dark:text-slate-300">
                        ...
                        <div
                          ...
                          className={`lesson-sidebar-lesson group w-full rounded-[22px] border px-4 py-4 text-left transition-all ${
                            isActive
                              ...
                              : isLocked
                                ? 'border-transparent bg-slate-100 dark:bg-gray-800/60 opacity-60 dark:bg-gray-900/[0.03]'
                                : 'border-transparent bg-white dark:bg-gray-900/80 hover:-translate-y-0.5 hover:border-slate-200 dark:border-gray-800 hover:bg-white dark:bg-gray-900/[0.03] dark:hover:border-white/10 dark:hover:bg-white dark:bg-gray-900/[0.05]'
                          }`}
                        >
                                ...
                                className={`mt-0.5 flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-2xl text-sm font-semibold ${
                                  courseLesson.isCompleted
                                    ...
                                    : isActive
                                      ...
                                      : isLocked
                                        ? 'bg-slate-200 text-slate-400 dark:bg-gray-900/10 dark:text-slate-500'
                                        : 'bg-slate-200 text-slate-600 dark:bg-gray-900/10 dark:text-slate-300'
                                }`}
                              >
      ...
      <div className="relative flex min-h-screen flex-col">
        <header className={`lesson-shell reveal-item reveal-1 sticky top-0 z-30 border-b backdrop-blur-xl transition-all duration-300 ${
          isEditorialHeader
            ...
            : 'border-slate-200 dark:border-gray-800/80 bg-[linear-gradient(115deg,rgba(255,255,255,0.96),rgba(248,250,252,0.9))] dark:border-white/10 dark:bg-[linear-gradient(115deg,rgba(2,6,23,0.92),rgba(15,23,42,0.84))]'
        }`}>
          <div className={`mx-auto flex w-full max-w-[1800px] items-center justify-between gap-3 px-4 sm:px-6 lg:px-8 transition-all duration-300 ${isHeaderCondensed ? 'py-2.5' : 'py-4'}`}>
            <div className="flex min-w-0 items-center gap-3 sm:gap-4">
              <Link
                href={buildCourseHref()}
                className={`lesson-icon-btn inline-flex flex-shrink-0 items-center justify-center rounded-2xl border text-slate-700 dark:text-gray-200 transition-all hover:-translate-y-0.5 hover:text-slate-900 dark:text-slate-300 dark:hover:text-white ${
                  isEditorialHeader
                    ? 'border-amber-200 bg-white dark:bg-gray-900/95 shadow-[0_16px_26px_-22px_rgba(217,119,6,0.5)] hover:border-amber-300 dark:border-amber-500/30 dark:bg-amber-500/10 dark:hover:border-amber-400/40'
                    : 'border-slate-200 dark:border-gray-800/90 bg-white dark:bg-gray-900/95 shadow-[0_12px_28px_-20px_rgba(15,23,42,0.55)] hover:border-slate-300 dark:border-white/10 dark:bg-gray-900/[0.04] dark:hover:border-white/20'
              ...
              <div className="min-w-0">
                ...
                <div className={`flex min-w-0 items-center gap-2 ${isHeaderCondensed ? 'mt-0.5' : 'mt-1'}`}>
                  <h1 className={`truncate text-slate-900 dark:text-white transition-all duration-300 dark:text-white ${
                    isEditorialHeader
                  ...
                  {!isHeaderCondensed && currentSection && (
                    <span className={`hidden lg:inline-flex rounded-full border px-2.5 py-1 text-[11px] font-medium ${
                      isEditorialHeader
                        ? 'border-amber-200 bg-white dark:bg-gray-900/95 text-amber-700 dark:border-amber-500/30 dark:bg-amber-500/10 dark:text-amber-200'
                        : 'border-slate-200 dark:border-gray-800 bg-white dark:bg-gray-900/90 text-slate-600 dark:border-white/10 dark:bg-gray-900/[0.05] dark:text-slate-300'
                    }`}>
                  ...
                  {!isHeaderCondensed && (
                    <span className={`hidden md:inline-flex rounded-full px-2 py-0.5 text-[11px] font-medium ${
                      isEditorialHeader
                        ...
                        : 'bg-slate-100 dark:bg-gray-800 text-slate-600 dark:bg-gray-900/10 dark:text-slate-300'
                    }`}>
            ...
            <div className="flex items-center gap-2">
              <div className="hidden items-center gap-2 sm:flex">
                ...
                >
                  <span className={`inline-flex items-center justify-center rounded-full bg-white dark:bg-gray-900/20 ${isHeaderCondensed ? 'h-6 w-6' : 'h-7 w-7'}`}>
              ...
              <div className={`flex items-center gap-1 rounded-2xl border p-1 ${
                isEditorialHeader
                  ? 'border-amber-200 bg-white dark:bg-gray-900/95 shadow-[0_14px_24px_-20px_rgba(217,119,6,0.45)] dark:border-amber-500/30 dark:bg-amber-500/10'
                  : 'border-slate-200 dark:border-gray-800/90 bg-white dark:bg-gray-900/90 shadow-[0_14px_26px_-24px_rgba(15,23,42,0.7)] dark:border-white/10 dark:bg-gray-900/[0.04]'
              }`}>
                <button
                  onClick={toggleTheme}
                  className={`lesson-icon-btn inline-flex items-center justify-center rounded-xl border border-transparent text-slate-700 dark:text-gray-200 transition-all hover:-translate-y-0.5 hover:text-slate-900 dark:text-slate-300 dark:hover:text-white ${
                    isEditorialHeader
                      ? 'hover:border-amber-200 hover:bg-white dark:bg-gray-900 dark:hover:border-amber-500/30 dark:hover:bg-amber-500/10'
                      : 'hover:border-slate-200 dark:border-gray-800 hover:bg-white dark:bg-gray-900 dark:hover:border-white/20 dark:hover:bg-white dark:bg-gray-900/[0.07]'
        ...
        <div className="mx-auto flex w-full max-w-[1800px] flex-1 gap-6 px-4 py-4 pb-28 sm:px-6 sm:pb-4 lg:px-8">
          <main className="min-w-0 flex-1 space-y-6">
            <section className="lesson-shell lesson-surface reveal-item reveal-2 overflow-hidden rounded-[32px] border border-slate-200 dark:border-gray-800/80 bg-white dark:bg-gray-900/80 shadow-[0_30px_90px_-40px_rgba(15,23,42,0.35)] backdrop-blur dark:border-white/10 dark:bg-slate-900/75">
              <div className="border-b border-slate-200 dark:border-gray-800/70 px-5 py-4 sm:px-6 dark:border-white/10">
                <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
                  <div className="min-w-0">
                    ...
                    <h2 className="mt-3 text-xl font-semibold leading-tight text-slate-900 dark:text-white sm:text-2xl dark:text-white">{lesson.title}</h2>
                      ...
                      <button
                        ...
                        className={`inline-flex items-center gap-1.5 whitespace-nowrap rounded-full border px-2.5 py-1 text-[11px] font-semibold tracking-[0.08em] transition ${
                          isCurrentLessonBookmarked
                            ? 'border-amber-300 bg-amber-50 text-amber-700 dark:border-amber-500/40 dark:bg-amber-500/10 dark:text-amber-200'
                            : 'border-slate-200 dark:border-gray-800 bg-white dark:bg-gray-900 text-slate-600 dark:border-white/10 dark:bg-gray-900/[0.04] dark:text-slate-300'
                        }`}
                      >
                    ...
                    {Array.isArray(course?.supportedLocales) && course.supportedLocales.length > 1 && (
                      <div className="mt-3 flex items-center gap-2 xl:justify-end">
                        ...
                        <select
                          ...
                          className="min-w-[220px] rounded-xl border border-slate-300 dark:border-gray-700 bg-white dark:bg-gray-900 px-3 py-2 text-sm font-medium text-slate-700 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-sky-500 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100"
                        >
              ...
              <div className="p-3 sm:p-4">
                <div className={`lesson-media-shell overflow-hidden rounded-[28px] border border-slate-200 dark:border-gray-800/70 bg-slate-950 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)] dark:border-white/10 ${isReadingLesson ? 'min-h-[390px]' : 'min-h-[420px]'}`}>
            ...
            <section className="reveal-item reveal-3 grid gap-4 lg:grid-cols-[minmax(0,1fr)_minmax(320px,420px)_minmax(0,1fr)]">
              <button
                ...
                className="lesson-surface lesson-nav-card group rounded-[28px] border border-slate-200 dark:border-gray-800/80 bg-white dark:bg-gray-900/80 p-5 text-left shadow-[0_30px_90px_-40px_rgba(15,23,42,0.35)] transition-all hover:-translate-y-0.5 hover:border-slate-300 dark:border-gray-700 disabled:cursor-not-allowed disabled:opacity-50 dark:border-white/10 dark:bg-slate-900/70 dark:hover:border-white/20"
              >
              ...
              <div className="lesson-surface rounded-[28px] border border-slate-200 dark:border-gray-800/80 bg-white dark:bg-gray-900/90 p-5 shadow-[0_30px_90px_-40px_rgba(15,23,42,0.35)] dark:border-white/10 dark:bg-slate-900/75">
                <div className="flex flex-col gap-5">
                  ...
                  <div className="h-2 overflow-hidden rounded-full bg-slate-200 dark:bg-none dark:bg-gray-900/10">
              ...
              <button
                ...
                className={`lesson-surface lesson-nav-card group rounded-[28px] border p-5 text-left shadow-[0_30px_90px_-40px_rgba(15,23,42,0.35)] transition-all hover:-translate-y-0.5 disabled:cursor-not-allowed disabled:opacity-50 ${
                  canGoToNext
                    ? 'border-emerald-200/80 bg-gradient-to-br from-white to-emerald-50/70 hover:border-emerald-300 dark:border-emerald-500/30 dark:from-slate-900/75 dark:to-emerald-500/10 dark:hover:border-emerald-400/40'
                    : 'border-slate-200 dark:border-gray-800/80 bg-white dark:bg-gray-900/80 hover:border-slate-300 dark:border-white/10 dark:bg-slate-900/70 dark:hover:border-white/20'
                }`}
              >
            ...
            <section className="lesson-shell lesson-surface reveal-item reveal-4 rounded-[32px] border border-slate-200 dark:border-gray-800/80 bg-white dark:bg-gray-900/80 p-3 shadow-[0_30px_90px_-40px_rgba(15,23,42,0.35)] backdrop-blur sm:p-4 dark:border-white/10 dark:bg-slate-900/75">
              <div className="lesson-tab-rail inline-flex flex-wrap gap-2 rounded-[22px] bg-slate-100 dark:bg-gray-800/90 p-1.5 dark:bg-gray-900/5">
                {[
              ...
              <div className="mt-4">
                          ...
                          <div className="mt-5 space-y-3">
                            {visibleResources.map((resource) => (
                              <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                            className="lesson-resource-row group flex items-center justify-between rounded-2xl border border-slate-200 dark:border-gray-800 bg-white dark:bg-gray-900 px-4 py-3 transition-all hover:-translate-y-0.5 hover:border-sky-200 dark:border-white/10 dark:bg-slate-950/40 dark:hover:border-sky-500/20"
                              >
                                <div className="min-w-0">
                                ...
                                <Download className="h-4 w-4 flex-shrink-0 text-slate-400 transition-transform group-hover:-translate-y-0.5 group-hover:text-slate-700 dark:text-gray-200 dark:group-hover:text-slate-200" />
                              </a>
                            ))}
                          </div>
                        ) : (
                ...
                {activeTab === 'qa' && (
                  <div className="lesson-panel rounded-[28px] border border-slate-200 dark:border-gray-800/80 bg-slate-50 dark:bg-gray-800/50 p-4 dark:border-white/10 dark:bg-slate-950/30">
        ...
        <div className="fixed inset-x-0 bottom-0 z-30 border-t border-slate-200 dark:border-gray-800/80 bg-white dark:bg-gray-900/95 backdrop-blur dark:border-white/10 dark:bg-slate-950/90 xl:hidden">
