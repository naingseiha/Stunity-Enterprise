...
export default function ToolsHubPage() {
  ...
  const tools = [
    ...
    { icon: Presentation, name: isKm ? 'ស្លាយបង្ហាញ' : 'Slides', desc: isKm ? 'ស្លាយបង្រៀនពី AI' : 'AI teaching decks', href: `/${locale}/tools/slides`, live: true, hue: 'from-violet-500 to-indigo-600' },
