      ...
      },
      {
        ...
        tools: [
          ...
          },
          {
            ...
            href: `/${locale}/grades/monthly-report?type=monthly`,
            icon: CalendarRange,
            tone: "amber",
          },
          {
            key: "semester-exam-report",
            title: t("semesterExamReport"),
            description: t("semesterExamReportDescription"),
            href: `/${locale}/grades/monthly-report?type=semester-exam`,
            icon: FileBarChart,
            tone: "blue",
          },
          {
            key: "semester-result-report",
            title: t("semesterResultReport"),
            description: t("semesterResultReportDescription"),
            href: `/${locale}/grades/monthly-report?type=semester`,
            icon: GraduationCap,
            tone: "emerald",
          },
          {
            key: "annual-result-report",
            title: t("annualResultReport"),
            description: t("annualResultReportDescription"),
            href: `/${locale}/grades/monthly-report?type=annual`,
            icon: Award,
            tone: "violet",
          },
          {
