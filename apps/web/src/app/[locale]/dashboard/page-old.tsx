...
function StatCard({
  ...
  return (
    <div className="group relative bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-sm hover:shadow-xl border border-gray-100 transition-all duration-300 hover:-translate-y-1">
...
function QuickActionCard({
  ...
  return (
    <button
      onClick={onClick}
      className="group relative bg-white dark:bg-gray-900 rounded-xl p-5 shadow-sm hover:shadow-lg border border-gray-100 transition-all duration-300 hover:-translate-y-0.5 text-left w-full"
    >
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          <h4 className="font-semibold text-gray-900 dark:text-white mb-1 group-hover:text-stunity-primary-600 transition-colors">
            {title}
          </h4>
...
export default function EnhancedDashboard({ params: { locale } }: { params: { locale: string } }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/20 to-purple-50/30">
      {/* Top Navigation Bar */}
      <nav className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 sticky top-0 z-40 backdrop-blur-lg bg-white dark:bg-gray-900/95">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-3">
              ...
              <button className="relative p-2 hover:bg-gray-100 dark:bg-gray-800 rounded-xl transition-colors">
              ...
              <button
                ...
                className="md:hidden p-2 hover:bg-gray-100 dark:bg-gray-800 rounded-xl transition-colors"
              >
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="relative overflow-hidden bg-gradient-to-r from-stunity-primary-600 via-purple-600 to-pink-600 rounded-3xl shadow-2xl mb-8">
          ...
          <div className="absolute top-0 right-0 w-96 h-96 bg-white dark:bg-gray-900/10 rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute bottom-0 left-0 w-96 h-96 bg-white dark:bg-gray-900/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-sm border border-gray-100">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="flex items-center gap-4 p-3 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800/50 dark:bg-gray-800/50 transition-colors">
            ...
            <div className="bg-gradient-to-br from-stunity-primary-600 to-purple-600 rounded-2xl p-6 shadow-lg text-white">
              ...
              <div className="space-y-3 mb-4">
                ...
                <div className="w-full bg-white dark:bg-gray-900/20 rounded-full h-2">
                  <div className="bg-white dark:bg-gray-900 rounded-full h-2" style={{ width: '65%' }}></div>
                </div>
                ...
                <div className="w-full bg-white dark:bg-gray-900/20 rounded-full h-2">
                  <div className="bg-white dark:bg-gray-900 rounded-full h-2" style={{ width: '90%' }}></div>
                </div>
                ...
                <div className="w-full bg-white dark:bg-gray-900/20 rounded-full h-2">
                  <div className="bg-white dark:bg-gray-900 rounded-full h-2" style={{ width: '50%' }}></div>
                </div>
              </div>
