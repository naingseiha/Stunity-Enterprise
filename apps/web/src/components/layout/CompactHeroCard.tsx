...
export default function CompactHeroCard({
  ...
  return (
    <div
      className={`relative h-full overflow-hidden rounded-[1.75rem] border border-white/70 p-5 shadow-[0_20px_50px_-12px_rgba(15,23,42,0.12)] sm:p-6 ${backgroundClassName}`}
    >
