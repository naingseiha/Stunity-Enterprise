...
import { getSubjectAbbreviation, paginateKhmerMonthlyReport } from '@/lib/reports/khmerMonthly';

interface KhmerMonthlyReportPrintProps {
...
export default function KhmerMonthlyReportPrint({ report, settings }: KhmerMonthlyReportPrintProps) {
  ...
  return (
    <div className="khmer-monthly-print">
      <style>{`
        ...
        :root {
          --khmer-report-heading-font: "Moul", "Khmer OS Muol Light", "Khmer OS Muol", serif;
          --khmer-report-body-font: "Battambang", "Khmer OS Battambang", "Khmer OS", serif;
        }
            ...
            <table className="khmer-monthly-table">
              <thead>
                <tr>
                  ...
                  {settings.showSubjects && report.subjects.map((subject) => (
