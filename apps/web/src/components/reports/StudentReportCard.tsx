    ...
    return (
      <div className="bg-white dark:bg-gray-900 rounded-[2rem] shadow-xl shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-gray-800 p-6 hover:scale-[1.02] transition-all">
        ...
        <div className="mt-6 pt-4 border-t border-gray-100 dark:border-gray-800 flex items-center justify-between text-[10px] font-black uppercase tracking-widest">
          <span className="text-gray-400 dark:text-gray-500">Ordinal: <span className="text-gray-900 dark:text-white">#{summary.classRank}</span> / {summary.totalStudents}</span>
    ...
    <div className="bg-white dark:bg-gray-900 rounded-[3rem] shadow-2xl shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-gray-800 overflow-hidden print:shadow-none transition-colors duration-500">
      ...
      <div className="bg-gradient-to-br from-blue-600 via-indigo-600 to-violet-600 dark:from-blue-950/40 dark:via-indigo-950/40 dark:to-violet-950/40 p-10 relative overflow-hidden group">
        ...
        <div className="flex flex-col md:flex-row md:items-start justify-between gap-8 relative z-10">
          <div className="flex items-center gap-8">
            ...
            <div>
              ...
              <div className="flex items-center gap-4 mt-6 text-[10px] font-black text-white/50 uppercase tracking-[0.2em]">
                <span className="px-3 py-1 bg-white/5 rounded-md border border-white/5">Identifier: {student.studentId || 'N/A'}</span>
          ...
          <div className="text-right">
            ...
            <div className="text-[10px] font-black text-white/50 uppercase tracking-[0.2em] mb-6">Aggregate Vector Average</div>
            <div className="flex flex-col items-end gap-4">
              <span className={`inline-block px-6 py-2 text-xs font-black uppercase tracking-widest rounded-xl border-2 shadow-2xl transition-all hover:scale-105 ${getGradeLevelColor(summary.overallGradeLevel)}`}>
                Distinction {summary.overallGradeLevel}
              </span>
              <button
      ...
      <div className="bg-gray-50 dark:bg-gray-950 px-8 py-5 border-b border-gray-100 dark:border-gray-800 flex flex-wrap items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-8">
          <div className="flex items-center gap-3">
            ...
            <span className="text-[10px] font-black text-gray-900 dark:text-white uppercase tracking-widest">Ordinal: <span className="text-amber-600">#{summary.classRank}</span> / {summary.totalStudents}</span>
          </div>
      ...
      <div className="p-10">
        <div className="flex items-center gap-3 mb-10">
          ...
          <h3 className="text-xl font-black text-gray-900 dark:text-white tracking-tight">Performance Matrix</h3>
        </div>

        {Object.entries(subjectsByCategory).map(([category, categorySubjects]) => (
          <div key={category} className="mb-12 last:mb-0">
            <div className="flex items-center gap-4 mb-6">
              <h4 className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-[0.3em] whitespace-nowrap">{category} Node</h4>
              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-gray-50/50 dark:bg-gray-950/50 border-b border-gray-100 dark:border-gray-800">
                    <th className="text-left py-5 px-6 text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest">Cognitive domain</th>
                    ...
                    <th className="text-center py-5 px-6 text-[10px] font-black text-blue-600 dark:text-blue-400 uppercase tracking-widest bg-blue-50/50 dark:bg-blue-500/5">Agg</th>
                    <th className="text-center py-5 px-6 text-[10px] font-black text-blue-600 dark:text-blue-400 uppercase tracking-widest bg-blue-50/50 dark:bg-blue-500/5">Rank</th>
                  </tr>
                </thead>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10">
          ...
          <div className="bg-gradient-to-br from-blue-50/50 via-indigo-50/30 to-violet-50/50 dark:from-blue-900/10 dark:via-indigo-900/10 dark:to-violet-900/10 rounded-[2rem] p-8 border border-blue-100 dark:border-blue-900/20 shadow-sm group">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center group/item">
                <span className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest">Cognitive Nodes</span>
              ...
              <div className="flex justify-between items-center group/item">
                <span className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest">Aggregate Scalar</span>
              ...
              <div className="flex justify-between items-center group/item">
                <span className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest">Distinction Vector</span>
              ...
              <div className="flex justify-between items-center group/item">
                <span className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest">Cohort Rank</span>
              ...
              <div className="flex justify-between items-center pt-6 mt-6 border-t border-blue-100 dark:border-blue-900/30 group/item">
                <span className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest">Integrity Status</span>
          ...
          <div className="bg-gradient-to-br from-emerald-50/50 via-teal-50/30 to-cyan-50/50 dark:from-emerald-900/10 dark:via-teal-900/10 dark:to-cyan-900/10 rounded-[2rem] p-8 border border-emerald-100 dark:border-emerald-900/20 shadow-sm group">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center group/item">
                <span className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest">Present Pulses</span>
              ...
              <div className="flex justify-between items-center group/item">
                <span className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest">Latency Events</span>
              ...
              <div className="flex justify-between items-center group/item">
                <span className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest">Void Events</span>
              ...
              <div className="flex justify-between items-center group/item">
                <span className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest">Authorized Void</span>
              ...
              <div className="flex justify-between items-center pt-6 mt-6 border-t border-emerald-100 dark:border-emerald-900/30 group/item">
                <span className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest">Engagement Efficiency</span>
      ...
      <div className="bg-gray-50 dark:bg-gray-950 px-10 py-6 text-center text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 dark:text-gray-600 border-t border-gray-100 dark:border-gray-800">
        Temporal Signature: {new Date(reportCard.generatedAt).toLocaleDateString('en-US', { 
          year: 'numeric', 
          month: 'long', 
          day: 'numeric',
          hour: '2-digit',
