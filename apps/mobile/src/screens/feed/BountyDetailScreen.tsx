...
const createStyles = (colors: any, isDark: boolean) => StyleSheet.create({
  ...
  explainBtn:         { flexDirection: 'row', alignItems: 'center', gap: 5, backgroundColor: ACCENT, paddingHorizontal: 12, paddingVertical: 8, borderRadius: 9999 },
  ...
  emptyExplainBtn:    { marginTop: 8, borderRadius: 9999, overflow: 'hidden' },
...
const replyStyles = StyleSheet.create({
  ...
  awardBtn:     { borderRadius: 9999, overflow: 'hidden' },
