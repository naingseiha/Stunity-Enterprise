...
export default function EditStudentScreen() {
  ...
  const loadStudent = useCallback(async () => {
    ...
    try {
      ...
      const customFields = student.customFields as Record<string, any> | undefined;
      ...
      setForm({
        ...
        email: student.email || '',
        placeOfBirth: getRegionalValue(customFields, 'placeOfBirth'),
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await studentsApi.updateStudent(params.studentId, {
