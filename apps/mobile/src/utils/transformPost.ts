...
export function transformPost(post: any): Post | null {
    try {
        return {
            ...
            mediaAspectRatio: post.mediaAspectRatio ?? post.media_aspect_ratio,
            mediaMetadata: post.mediaMetadata || post.media_metadata || post.media || [],
            ...
            repostOf: post.repostOf ? {
                ...
                mediaAspectRatio: post.repostOf.mediaAspectRatio ?? post.repostOf.media_aspect_ratio,
                mediaMetadata: post.repostOf.mediaMetadata || post.repostOf.media_metadata || post.repostOf.media || [],
